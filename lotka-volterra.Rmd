...
As described in the lecture, the Lotka-Volterra models have been used to describe predator-prey populations.
...
parameters <- c(alpha = 5, beta = 3, delta = 0.5, gamma = 1)
